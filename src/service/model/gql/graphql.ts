...
export type PlainAccountFragment = {
    __typename?: "Account";
    id: number;
    name: string;
    type: AccountType;
...
export type CreateCategoryMutation = {
    ...
    createCategoryV2?: {
        __typename?: "CreateCategoryV2Payload";
        category?: { __typename?: "Category"; id: number; name: string; type: CategoryType } | null;
    } | null;
};
...
export type PlainCategoryFragment = {
    __typename?: "Category";
    id: number;
    name: string;
    type: CategoryType;
...
export type PlainTransactionFragment = {
    __typename?: "Transaction";
    id: number;
    amount: number;
    description: string;
...
export type GetTransactionsByFromAccountQuery = {
    __typename?: "Query";
    transactions?: {
        __typename?: "TransactionsConnection";
        totalCount: number;
...
export type GetTransactionMonthYearListByAccountIdQuery = {
    __typename?: "Query";
...
export const PlainAccountFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
            name: { kind: "Name", value: "PlainAccount" },
...
} as unknown as DocumentNode<PlainAccountFragment, unknown>;
export const PlainCategoryFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
            name: { kind: "Name", value: "PlainCategory" },
...
} as unknown as DocumentNode<PlainCategoryFragment, unknown>;
export const PlainTransactionFragmentDoc = {
    kind: "Document",
    definitions: [
        {
            kind: "FragmentDefinition",
            name: { kind: "Name", value: "PlainTransaction" },
            ...
            selectionSet: {
                ...
                selections: [
                    ...
                    { kind: "Field", name: { kind: "Name", value: "fromAccountId" } },
                    { kind: "Field", name: { kind: "Name", value: "toAccountId" } },
                ],
            },
        },
    ],
} as unknown as DocumentNode<PlainTransactionFragment, unknown>;
...
} as unknown as DocumentNode<GetAllAccountsQuery, GetAllAccountsQueryVariables>;
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                ...
                },
                {
                    ...
                    type: {
                        kind: "NonNullType",
                        type: { kind: "NamedType", name: { kind: "Name", value: "AccountType" } },
                    },
                },
            ],
            selectionSet: {
                                ...
                                value: {
                                    ...
                                    fields: [
                                        ...
                                        },
                                        {
                                            kind: "ObjectField",
                                            name: { kind: "Name", value: "balance" },
                                            value: { kind: "FloatValue", value: "0.0" },
                                        },
                                    ],
                                },
                            },
    ...
    definitions: [
        {
            ...
            selectionSet: {
                ...
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "closeAccount" },
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "input" },
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                ...
                },
                {
                    ...
                    type: {
                        kind: "NonNullType",
                        type: { kind: "NamedType", name: { kind: "Name", value: "CategoryType" } },
                    },
                },
            ],
            selectionSet: {
                ...
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "createCategoryV2" },
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "input" },
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                ...
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "fromAccountId" } },
                    type: {
                        kind: "NonNullType",
                        type: { kind: "NamedType", name: { kind: "Name", value: "Int" } },
                    },
...
} as unknown as DocumentNode<AddExpenseMutation, AddExpenseMutationVariables>;
export const AddIncomeDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            ...
            variableDefinitions: [
                ...
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "toAccountId" } },
                    type: {
                        kind: "NonNullType",
                        type: { kind: "NamedType", name: { kind: "Name", value: "Int" } },
                    },
...
} as unknown as DocumentNode<AddIncomeMutation, AddIncomeMutationVariables>;
export const AddTransferDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            ...
            selectionSet: {
                ...
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "transferV2" },
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "input" },
...
} as unknown as DocumentNode<AddTransferMutation, AddTransferMutationVariables>;
...
export const GetTransactionsByFromAccountDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetTransactionsByFromAccount" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "accountId" } },
    ...
    GetTransactionsByFromAccountQuery,
    GetTransactionsByFromAccountQueryVariables
>;
export const GetTransactionMonthYearListByAccountIdDocument = {
    kind: "Document",
    definitions: [
        {
            kind: "OperationDefinition",
            operation: "query",
            name: { kind: "Name", value: "GetTransactionMonthYearListByAccountId" },
            variableDefinitions: [
                {
                    kind: "VariableDefinition",
                    variable: { kind: "Variable", name: { kind: "Name", value: "accountId" } },
            ...
            selectionSet: {
                ...
                selections: [
                    {
                        kind: "Field",
                        name: { kind: "Name", value: "transactionMonthYearListByAccountId" },
                        arguments: [
                            {
                                kind: "Argument",
                                name: { kind: "Name", value: "accountId" },
    ...
    GetTransactionMonthYearListByAccountIdQuery,
    GetTransactionMonthYearListByAccountIdQueryVariables
>;
...
} as unknown as DocumentNode<CurrentUserMutation, CurrentUserMutationVariables>;
